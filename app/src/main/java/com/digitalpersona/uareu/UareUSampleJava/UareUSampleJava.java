...
public class UareUSampleJava extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setButtonsEnabled(false);
        m_getReader.setEnabled(false);
        m_getReader.setEnabled(true);
        switchUsb("2");
    ...
    private void displayReaderNotFound() {
        ...
        setButtonsEnabled(false);
        if (!isFinishing()) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(UareUSampleJava.this);
